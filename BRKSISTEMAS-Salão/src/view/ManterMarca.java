 ...
 * @author suporte
 */
public class ManterMarca extends javax.swing.JInternalFrame {
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ConsultarMarca f2 = new ConsultarMarca();
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        crtl.getMarcaTo().setNomeMarca(txtDescricao.getText());
        crtl.incluirMarca();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente alterar a marca: " + txtDescricao.getText() + "?", title, JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
            crtl.getMarcaTo().setCodMarca(Integer.parseInt((txtCodigo.getText())));
            crtl.getMarcaTo().setNomeMarca(txtDescricao.getText());
            crtl.alterarMarca();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente excluir a marca: " + txtDescricao.getText() + "?", title, JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
    ...
    public void recebendo(MarcaTO to) {
        txtCodigo.setValue(to.getCodMarca());
